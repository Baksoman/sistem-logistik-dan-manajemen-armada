...
<section id="cta-section" class="section-fade-in relative w-full py-24 px-6 bg-gray-100 overflow-hidden">
    ...
    <div class="max-w-6xl mx-auto relative z-10">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
                ...
                <div class="mt-8 space-y-4">
                    ...
                    <div class="flex items-center gap-4">
                        <div class="w-7 h-7 rounded-lg bg-gray-100 shadow-[inset_3px_3px_6px_#c2c6cc,inset_-3px_-3px_6px_#ffffff] flex items-center justify-center flex-shrink-0">
            ...
            <div>
                <div class="bg-gray-100 rounded-xl p-8 md:p-10 shadow-[16px_16px_32px_#c2c6cc,-16px_-16px_32px_#ffffff]">
                    ...
                    <form id="quoteForm" class="space-y-5">
                        ...
                        <div class="flex gap-4 pt-2">
                            <button type="submit" class="flex-1 bg-gray-100 text-gray-700 font-black uppercase tracking-widest text-sm py-4 rounded-xl shadow-[6px_6px_12px_#d1d5db,-6px_-6px_12px_#ffffff] active:shadow-[inset_4px_4px_8px_#d1d5db,inset_-4px_-4px_8px_#ffffff] hover:text-gray-900 transition-all">Kirim Request</button>
                            <a href="https://wa.me/6281234567890" target="_blank" class="w-14 flex items-center justify-center bg-gray-100 text-green-500 rounded-xl shadow-[6px_6px_12px_#d1d5db,-6px_-6px_12px_#ffffff] active:shadow-[inset_4px_4px_8px_#d1d5db,inset_-4px_-4px_8px_#ffffff] transition-all">
