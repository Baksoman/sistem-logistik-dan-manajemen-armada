...
<section id="stats-section" class="section-fade-in relative w-full py-24 px-6 bg-gray-100 overflow-hidden">
    ...
    <div class="relative z-10 max-w-6xl mx-auto">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8" x-data="statsCounter">
            @foreach([
            ...
            <div class="stat-card text-center" x-intersect="startCount({{ $loop->index }}, {{ $stat['count'] }})">
                ...
                <div class="flex items-baseline justify-center gap-0.5">
                    <div class="text-4xl md:text-5xl font-black text-gray-800" x-text="formatNumber(counts[{{ $loop->index }}])">0</div>
